...
router.get('/users-list', authenticateToken, requireRole('admin'), listUsersWithRoles);
router.get('/users/:id', authenticateToken, requireRole('admin'), getUserDetails);
router.post('/users/assign-role', authenticateToken, requireRole('admin'), assignAdminRole);
router.post('/users/remove-role', authenticateToken, requireRole('admin'), removeAdminRole);
router.get('/admin-users', authenticateToken, requireRole('admin'), listAdminUsers);
router.put('/users/:userId/admin-role', authenticateToken, requireRole('admin'), updateUserAdminRole);
router.get('/users/:userId/activity-stats', authenticateToken, requireRole('admin'), getUserActivityStats);
